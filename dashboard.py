...
<style>
    ...
    /* Date picker calendar styling - white background, dark text */
    ...
    .stDateInput div[data-baseweb="calendar"] div:not([aria-selected="true"]) {
        color: #333 !important;
    }
    
    /* Force white background on all calendar elements except selected */
    .stDateInput [data-baseweb="calendar"] div:not([aria-selected="true"]),
    .stDateInput [data-baseweb="calendar"] span:not([aria-selected="true"]),
    .stDateInput [data-baseweb="calendar"] button:not([aria-selected="true"]) {
        background-color: white !important;
    }
</style>
